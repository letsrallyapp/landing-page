...
export function FeatureSection() {
  return (
    <section
      id="why-rally"
      className="bg-[#f8f2e9] py-20 text-[#151515] sm:py-28">
        ...
        <div className="grid divide-y-2 divide-[#151515] md:grid-cols-2 md:divide-x-2 md:divide-y-0">
          {stories.map((story, index) => {
            ...
            return (
              <motion.article
                key={story.number}
                className="py-10 md:px-10 md:py-14 first:pl-0 last:pr-0"
                initial={{
                  opacity: 0,
                  y: 16
                }}
                ...
                <div
                  className={`mt-8 flex w-fit items-center gap-2.5 rounded-sm ${story.accent} px-3 py-2.5 text-xs font-extrabold text-[#151515]`}>
