...
export function PhonePreview() {
  return (
    <motion.div
      className="relative mx-auto w-[278px] sm:w-[310px]"
      initial={{
        opacity: 0,
        y: 28,
        rotate: 2
      ...
      aria-label="Preview of the Taco Night temporary event chat in the Let's Rally app"
      role="img">
      
      <div
        className="absolute -left-10 top-20 hidden h-24 w-24 border-2 border-[#ff735f] md:block"
        aria-hidden="true" />
      
      <div
        className="absolute -right-7 bottom-20 h-16 w-16 rounded-full bg-[#ff735f]"
        aria-hidden="true" />
        ...
        <div className="overflow-hidden rounded-[2.25rem] bg-[#f8f2e9]">
          ...
          <div className="px-4 pb-4 pt-4">
            ...
            <div className="mt-4 flex items-center justify-between border-t border-[#151515]/10 pt-3">
              <div className="flex -space-x-2">
                ...
                <img
                  ...
                  className="h-6 w-6 rounded-full border-2 border-[#f8f2e9] object-cover" />
            ...
            <div className="mt-3 flex items-center gap-2 rounded-full bg-[#e8e0d4] px-3 py-2 text-[10px] font-semibold text-[#151515]/45">
              Message Taco Night
              <SendIcon
                className="ml-auto h-3.5 w-3.5 text-[#151515]"
                aria-hidden="true" />
